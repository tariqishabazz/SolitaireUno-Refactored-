...
namespace SolitaireUno
{
    ...
    public class GameMethods
    {
        ...
        /// game rules.
        /// </summary>
        /// <remarks>A card is considered a valid play if its value is exactly one less/more than the currently
        ...
        public static bool ValidCard(Card potentialPlay, Card currentlyShown)
        {
            ...
            else
            {
                ...
                else if (potentialPlay.Value == Values.Ace && currentlyShown.Value == Values.King)
                {
                    return true;
                }
                return false;
